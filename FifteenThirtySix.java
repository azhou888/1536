...
public class FifteenThirtySix {
    ...
    public static void main(String[] args) {
        FifteenThirtySix t = new FifteenThirtySix();
        t.printGameState();
    ...
    /**
     * reset the game state to start a new game with
     * set positions for the initially generated threes.
